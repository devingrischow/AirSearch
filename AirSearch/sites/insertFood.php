...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
    ...
    <a href=<?php echo "#" ?>><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-up-left" viewBox="0 0 16 16">
...
<?php
    ...
    try{
        ...
        $add = "INSERT INTO $tableSelect (name, temperature, timeMinutes, timeSeconds, recipe, rating, imageName) VALUES (:name, :temperature, :timeMinutes, :timeSeconds, :recipe, :rating, :imageName)"; #sql text to be queried, :tobesearched is a placeholder that will be binded to the value of user search
        ...
        $imageN = filter_input(INPUT_POST, 'imageName');
        $addstmt->bindValue(':imageName', $imageN, PDO::PARAM_STR);                                
        ...
        if ($success){      #if the execute is successful it will echo the film printed successfully
            echo "Entry Added - Go back To Search Screen ->";
